...
#SBATCH --output=ppo_mujoco/cpu/brax_paper_baseline/brax_paper_baseline_%A_%a.out
#SBATCH --array=0-8
...
python ppo_continuous_action.py --id ${SLURM_ARRAY_TASK_ID} --confs "brax_paper_baseline_config.bin"

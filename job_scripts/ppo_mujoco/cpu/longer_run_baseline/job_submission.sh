...
#SBATCH --output=ppo_mujoco/cpu/brax_longer_timestep_baseline/brax_longer_timestep_baseline_%A_%a.out
#SBATCH --array=0-5
...
python ppo_continuous_action.py --id ${SLURM_ARRAY_TASK_ID} --confs "brax_longer_timestep_baseline_config.bin"
